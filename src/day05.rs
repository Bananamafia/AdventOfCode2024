pub mod day05 {
    ...
    pub fn get_clean_ordering_rules(rules: Vec<(i32, i32)>) -> HashMap<i32, Vec<i32>> {
    ...
    pub fn solve_part_1(input: &str) -> i32 {
        ...
        let cleaned_rules: HashMap<i32, Vec<i32>> = get_clean_ordering_rules(rules);
...
75|29";
            ...
            let actual: HashMap<i32, Vec<i32>> =
                get_clean_ordering_rules(get_ordering_rules(input));
